...
export function calendarModal() {
    ...
    modal.innerHTML = `<summary class="button flex justify-around items-center px-3">Actions<i class='bx  bx-arrow-down-stroke text-xl'  style='color:#000000'></i></summary>
